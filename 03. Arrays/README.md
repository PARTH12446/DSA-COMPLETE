...
- **Step 1 – Pick a problem from Striver’s sheet**
  - Find the matching array problem in this folder by name/number.
- **Step 2 – Solve it yourself first**
  - Try on the original platform (LeetCode / GfG / CN) without looking at this code.
- **Step 3 – Compare with the solution here**
  - Check:
    - Is your approach using the same pattern (prefix-sum, hashing, two pointers, etc.)?
    - Is there a cleaner or more optimal way?
- **Step 4 – Add your own notes**
  - At the top of the `.java` file or in this `README`, write:
    - 1–2 lines of idea/pattern
    - Any tricky edge cases
    - Time & space complexity

This way the folder becomes your **personal notes + solution bank** for Arrays.

## Progress

Use these checkboxes to track your Arrays progress:

- [ ] Finished all **Easy** array problems
- [ ] Finished all **Medium** array problems
- [ ] Finished all **Hard** array problems
- [ ] Did **one full revision** of Arrays
- [ ] Re-solved the **10–15 most important** array problems without help
